...
function copyStyleSubset(source, target, styles) {
  var css_style_declaration = getComputedStyle(source);
...
*/
function dentSelection(textarea, dedent, tab) {
...
*/
function autoindentNewline(textarea, jump) {
...
Textarea.prototype.resizeToFit = function() {
  if (this.shadow.clientWidth != this.el.clientWidth) {
    var tmp_style = getComputedStyle(this.el);
  ...
  var shadow_style = getComputedStyle(this.shadow);
...
if (typeof window.angular !== 'undefined') {
  window.angular.module('textarea', []).directive('enhance', function() {
    return {
      restrict: 'A',
      require: '?ngModel',
